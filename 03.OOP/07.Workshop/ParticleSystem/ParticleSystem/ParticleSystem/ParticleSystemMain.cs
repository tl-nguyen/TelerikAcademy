    ...
    class ParticleSystemMain
    {
        ...
        static void Main(string[] args)
        {
            ...
            var particles = new List<Particle>()
            {
                ...
                //new ChaoticParticle(new MatrixCoords(15, 20), new MatrixCoords(2, 2), new Random()),
                //new ChickenParticle(new MatrixCoords(15, 30), new MatrixCoords(2, 2), RandomGenerator, 5),
                new ParticleRepeller(new MatrixCoords(15,30), new MatrixCoords(0,0), 200, 3)
            };
